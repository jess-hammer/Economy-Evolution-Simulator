...
public class ItemStash {
    public Item [] items = new Item[] {
        new Item(ItemName.VEGETABLE, 1, 0, 0.2f, 0.5f, 20, 2, Random.Range(0.5f, 1f)),
        new Item(ItemName.GRAIN, 1, 0, 0.2f, 2, 20, 1, Random.Range(0.5f, 1f)),
        new Item(ItemName.MEAT, 1, 0, 0.7f, 2, 20, 3, Random.Range(0.5f, 1f)),
        new Item(ItemName.TRINKET, 0, 0, 0.8f, 0.1f, 5, (int)Random.Range(5f, 10f), Random.Range(0, 0.5f)),
        new Item(ItemName.PEBBLE, 0, 0, 0, 0.1f, 2, 1000, 1),
        new Item(ItemName.TOOL, 0, 1, 0.1f, 10, 20, (int)Random.Range(5f, 10f), Random.Range(0, 0.5f)),
        new Item(ItemName.FURNITURE, 0.2f, 0.4f, 0.2f, 30, 100, (int)Random.Range(10f, 20f), Random.Range(0, 0.5f)),
        new Item(ItemName.CLOTHING, 0.2f, 0.4f, 0.2f, 1, 50, (int)Random.Range(5f, 10f), Random.Range(0, 0.5f)),
        new Item(ItemName.TOILET_PAPER, 0.2f, 0.1f, 0f, 0.1f, 10, 6, Random.Range(0, 0.5f))
    };
}
